...
res = (4, tuple_d.count(4)), (5, tuple_d.count(5)), (4, tuple_d.count(4)), (5, tuple_d.count(5)), (6, tuple_d.count(6)), (7, tuple_d.count(7)), (8, tuple_d.count(8)), (4, tuple_d.count(4)), (5, tuple_d.count(5)), (6, tuple_d.count(6)), (7, tuple_d.count(7)), (8, tuple_d.count(8))
print(res)

3)
tuple_d = (1, 2, 3, 4, 5, 4, 5, 6, 7, 8, 4, 5, 6, 7, 8, 9, 10, 11)
for index in enumerate(tuple_d):
    print(index) # Індекси я знаю як знайти, а дальше я застряг